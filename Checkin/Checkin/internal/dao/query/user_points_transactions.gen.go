...
type userPointsTransaction struct {
	...
	PointsChange   field.Int64 // 积分变动值 (正数为增加，负数为扣除)
	CurrentBalance field.Int64 // 当前余额
	/*
		交易类型(1:签到 2:连续签到 3:补签 4:每⽇任务
		5:福利任务)
	*/
	TransactionType field.Int32
	Description     field.String // 积分变动说明
	ExtJSON         field.String // 扩展字段
